...
public class ConfigScreen extends Screen {
    ...
    private static final ResourceLocation FOOTER_SEPARATOR = ResourceLocation.withDefaultNamespace("textures/gui/footer_separator.png");
    private static final ResourceLocation INWORLD_FOOTER_SEPARATOR = ResourceLocation.withDefaultNamespace("textures/gui/inworld_footer_separator.png");
    ...
    private void buildTimestampEditor(int x, int y, int w) {
        addDynamic(CycleButton.<RichPresenceProfile.TimestampMode>builder(
                ...
                .withInitialValue(editingProfile.getTimestampMode())
    ...
    public void render(GuiGraphics g, int mx, int my, float pt) {
        ...
        for (TextLine line : textLines) {
            g.drawString(font, line.text(), line.x(), line.y(), line.color(), line.shadow());
        }
        ...
        if (statusMessage != null && statusUntilMs > now) {
            ...
            g.drawString(font, statusMessage, sx, sy, COLOR_GREEN, true);
        }
    }

    private void renderPreviewHint(GuiGraphics g) {
        ...
        for (var line : font.split(hint, previewW - 8)) {
            ...
            g.drawString(font, line, previewX + (previewW - lw) / 2, y, COLOR_HINT, false);
            y += 10;
        }
    }
    ...
    private void renderVariablesReference(GuiGraphics g, int startY) {
        ...
        for (int i = 0; i < VARIABLES.length; i++) {
            ...
            g.drawString(font, VARIABLES[i][0], colX, rowY, COLOR_VAR, false);
            ...
            g.drawString(font, desc, colX + keyW, rowY, COLOR_HINT, false);
        }
    }
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (tabBar != null && tabBar.keyPressed(keyCode)) return true;
